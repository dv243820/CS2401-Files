...
// ACCESSOR FUNCTIONS
// This function returns the color as a number which is how it is actually stored
unsigned long Swatch::get_color(){
     return color;
}

// This function returns a string version of the color number in standard RGB format
