/*************************************************************************
    ...
    will need to write the Big 3 for this class.
        ...
        Patricia Lindner    September 2022       Ohio University EECS
*************************************************************************/
...
int main()
{
    ...
    string songname, artist, username, filename, sorting;
    int choice, choice2;
    bool cutout;
    ...
    while (choice != 9)
    {
        ...
        case 5:
            ...
            song = mySongs.find_song(songname, artist);
            if (song != Song())
                cout << song << endl;
            break;
        case 6:
